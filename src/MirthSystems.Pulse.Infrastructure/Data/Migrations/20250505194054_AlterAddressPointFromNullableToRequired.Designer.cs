...
namespace MirthSystems.Pulse.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250505194054_AlterAddressPointFromNullableToRequired")]
    partial class AlterAddressPointFromNullableToRequired
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MirthSystems.Pulse.Core.Entities.Address", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MirthSystems.Pulse.Core.Entities.OperatingSchedule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MirthSystems.Pulse.Core.Entities.Special", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MirthSystems.Pulse.Core.Entities.Venue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MirthSystems.Pulse.Core.Entities.OperatingSchedule", b =>
                {
                    b.HasOne("MirthSystems.Pulse.Core.Entities.Venue", "Venue")
            ...
            modelBuilder.Entity("MirthSystems.Pulse.Core.Entities.Venue", b =>
                {
                    b.HasOne("MirthSystems.Pulse.Core.Entities.Address", "Address")
                        .WithOne("Venue")
                        .HasForeignKey("MirthSystems.Pulse.Core.Entities.Venue", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
