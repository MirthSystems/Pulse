...
namespace Pulse.Data.Migrations
{
    ...
    [Migration("20250523023103_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pulse.Data.Entities.BusinessHours", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Pulse.Data.Entities.DayOfWeek", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Pulse.Data.Entities.Special", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Pulse.Data.Entities.SpecialCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Pulse.Data.Entities.Venue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Pulse.Data.Entities.VenueCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("BitMask")
                        .IsUnique()
                        .HasDatabaseName("ix_venue_categories_bit_mask");
            ...
            modelBuilder.Entity("Pulse.Data.Entities.BusinessHours", b =>
                {
                    b.HasOne("Pulse.Data.Entities.DayOfWeek", "DayOfWeek")
                    ...
                    b.HasOne("Pulse.Data.Entities.Venue", "Venue")
                        .WithMany("BusinessHours")
            ...
            modelBuilder.Entity("Pulse.Data.Entities.Special", b =>
                {
                    b.HasOne("Pulse.Data.Entities.SpecialCategory", "Category")
                        .WithMany("Specials")
            ...
            modelBuilder.Entity("Pulse.Data.Entities.Venue", b =>
                {
                    b.HasOne("Pulse.Data.Entities.VenueCategory", "Category")
                        .WithMany("Venues")
