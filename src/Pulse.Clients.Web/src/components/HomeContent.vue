    ...
    <div class="row">
      <div class="col-md-5 mb-4">
        ...
        <p>
          ...
          Azure, and more. You can also use any OAuth2 Authorizati[...]
        </p>
      </div>
      ...
      <div class="col-md-5 mb-4">
        ...
        <p>
          ...
          identifying information. Push notifications, authenticator app[...]
        </p>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-5 mb-4">
        ...
        <p>
          ...
          suspicious activity, as well as block further login atte[...]
        </p>
      </div>
      ...
      <div class="col-md-5 mb-4">
        ...
        <p>
          ...
          complete, and you can use them to customize and extend[...]
        </p>
      </div>
    </div>
  </div>
